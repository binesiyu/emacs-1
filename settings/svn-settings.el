...
;; Time-stamp: <2012-03-12 13:36:39 Monday by taoshanwen>
...
(eal-define-keys
 `(emacs-lisp-mode-map c-mode-base-map sgml-mode-map
                       ...
                       c++-mode-map image-mode-map nxml-mode-map python-mode-map py-mode-map)
 `(("C-c l" svn-status-show-svn-log)))

(eal-define-keys makefile-mode-map-list  `(("C-c l" svn-status-show-svn-log)))
